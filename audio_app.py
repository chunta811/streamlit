...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'google_audio_credential.json'

def synthesize(text, lang='日本語', gender='Default'):
    gender_type = {
...
if input_option == '直接入力':
    input_data = st.text_area('こちらにテキストを入力してください。', 'Cloud Speech-to-Text用のサンプル文章です。')
else:
...
if input_data is not None:
    ...
    if st.button('開始'):
        ...
        response = synthesize(input_data, lang=lang, gender=gender)
